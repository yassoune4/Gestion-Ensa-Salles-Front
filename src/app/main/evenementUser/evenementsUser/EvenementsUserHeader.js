...
function EvenementsUserHeader(props)
{
    ...
    return (
        <div className="flex flex-1 w-full items-center justify-between">
            ...
            <FuseAnimate animation="transition.slideRightIn" delay={300}>
                <Button component={Link} to="/apps/user/events/new" className="whitespace-no-wrap" variant="contained">
                    <span className="hidden sm:flex">Add New Evenement</span>
...
export default EvenementsUserHeader;
